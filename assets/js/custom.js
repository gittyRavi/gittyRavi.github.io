$(document).ready(function () {
    ...
    contacts = {
        ...
        "Facebook": ["facebook", "Facebook<br/><i class='fa fa-facebook'></i>", "#3b5998", "white"],
        "GitHub": ["github", "GitHub<br/>. . .", "#333", "white"],
        "Twitter": ["twitter", "<i class='fa fa-twitter'></i> Twitter <i class='fa fa-twitter'></i>", "#1da1f2", "white"],
        "LinkedIn": ["linkedin", "LinkedIn", "#0077b5", "white"],
        "Mail": ["mail", "Want To Meet Up huh ... &#133662110195;<br/><h1>Mail Me Here</h1>", "black", "white"],
        "Resume": ["resume", "Know Me<br/><h1>😊 & Hire Me! 😊</h1>", "black", "white"],
        "Medium": ["medium", "Medium", "#00ab6c", "white"],
        "Angel": ["angel", "<i class='fa fa-angellist'></i> Angel <i class='fa fa-angellist'></i>", "white", "black"],
        "Amazon": ["amazon", "<span style='font-size: 0.6em'>Buy Me Something from My Amazon Wishlist!<br>Thanks!</span><br/><i class='fa fa-amazon'></i>", "#ff9900", "black"],
		"Snapchat": ["snapchat", "Snapchat Me!!<br/><i class='fa fa-snapchat-ghost'></i>", "yellow", "black"],
		"Brainstorming": ["weblink", "&#x219D; Brainstorming &#x219D;<br><h1 style='color:white'><i class='fa fa-heart' id='heart'></i> visit my new website <i class='fa fa-heart' id='heart'></i></h1>", "pink", "purple"]
    }
...
//    var loves = ["making websites", "Sweja", "web designing"];
    ...
    $(function () {
        var hello = ["Making Websites", "Web Designing", "Google", "Open Source", "HTML, CSS and JS", "Django", "Python", "C++", "Astronomy", "Drawing & Painting", "JavaScript", "Machine Learning", "Artificial Intelligence"];
        var used = ["Sweja"];
        var greeting = $('#loves');
        var item;
...
//            console.log("j = " + j);
        ...
        window.setInterval(function () {
            ...
            setTimeout(hey, 0)
        }, 500);        //interval between word change
